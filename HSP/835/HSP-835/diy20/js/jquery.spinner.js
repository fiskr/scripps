...
//(function($) {
    $.fn.spinner = function(options) {
        ...
        return this.each(function() {
            ...
            var pos = $this.offset();
            w = $this.outerWidth() -14;
            h = $this.outerHeight() -14;
            ...
            $s = $('<div style="display:none;padding:10px;background:#000;opacity:.8;-moz-border-radius:4px;border-radius:4px;position: absolute; left: ' + l +'; top: ' + t + ';width: ' + opts.width + 'px; height: ' + opts.height + 'px; z-index: ' + opts.zIndex + ';"><img src="' + opts.img + '" /></div>');

			$s.appendTo('body').fadeIn(350);
    ...
    $.fn.spinner.defaults = {
        ...
        , img       : 'http://www.sndimg.com/webhgrm/rm10/imgs/le/loader-dark.gif' // path to spinner img
