...
var HWDomElems = {
    ...
    HWSweepsCfg = {
        ...
        'docReady' : function() {
           console.log('doc ready from init')
            ...
            'thanks' : {
                ...
                'omniture' : {
                    ...
                    'mdm_override' : {
                        ...
                        'Sponsorship' : 'HG_TP_URBAN_OASIS_SWEEPS_THANKS'
                    }
                }
            },
    ...
    addEvent( "message", window, function(event){
        ...
        if (event.data.match(/block_abandon/)) {
            ...
            setTimeout(function() {
                ...
                if (SNI.TP.Sweeps.HelloWorld.currentState !== 'thanks') {
                    allowAbndnTrack = true;
                }
...
setTimeout(SNI.TP.Sweeps.HelloWorld.setDefaultState(), 50000);
