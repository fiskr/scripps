...
class Minify_CSS {
	...
	// jford - 2008-08-27
	public static $should_minify = true;
    ...
    {
        if (!Minify_CSS::$should_minify) return $css;
    ...
    protected static function _minify($css, $options) 
    {
        ...
        //$css = preg_replace('/;?\\s*}\\s*/', '}', $css);		// this version strips the trailing ; from the last rule before closing }
        $css = preg_replace('/;?\\s*}\\s*/', ';}', $css);			// this version does not strip the trailing ;
